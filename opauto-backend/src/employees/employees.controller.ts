...
export class EmployeesController {
  ...
  @Post() create(@CurrentUser('garageId') gid: string, @Body() dto: CreateEmployeeDto) { return this.service.create(gid, dto); }
  @Put(':id') update(@Param('id') id: string, @CurrentUser('garageId') gid: string, @Body() dto: UpdateEmployeeDto) { return this.service.update(id, gid, dto); }
