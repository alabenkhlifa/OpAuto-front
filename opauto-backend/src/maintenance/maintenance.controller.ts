...
export class MaintenanceController {
  ...
  @Post() create(@CurrentUser('garageId') gid: string, @Body() dto: CreateMaintenanceDto) { return this.service.create(gid, dto); }
  @Put(':id') update(@Param('id') id: string, @CurrentUser('garageId') gid: string, @Body() dto: UpdateMaintenanceDto) { return this.service.update(id, gid, dto); }
