...
export class ApprovalsController {
  ...
  @Post() @RequireModule('approvals') create(@CurrentUser('garageId') gid: string, @CurrentUser('id') uid: string, @Body() dto: CreateApprovalDto) { return this.service.create(gid, uid, dto); }
  @Put(':id/respond') @RequireModule('approvals') @UseGuards(RolesGuard) @Roles(UserRole.OWNER)
